function rpthumbnt(json) {
 ...
 for (var i = 0; i < numposts; i++) {
  ...
  document.write('<a href="http://grosirtanahabang27.blogspot.co.id/feeds/posts/default?orderby=published&alt=json-in-script&callback=rpthumbnt">' + posttitle + '</a><br>');
  if ("content" in entry) {
